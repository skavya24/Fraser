...
function snowRatio(temperature, wind) {
  ...
  if (temperature >= 110 || temperature <= -80 || wind >= 40 || wind < 0) {
...
//instructions
console.log("Snow Ratio Predictor")
console.log("Enter temperature and wind speed values for each city. Seperate values using only a space.")
console.log("")
console.log("Format: ('temperature Fahrenheit' 'wind km/h')")
console.log("Temp range: -80 to 100 degrees F")
console.log("Wind range: 0 to 40 km/h")
console.log("")

//example/test value
const ON = "14 8"
let ONsplit = ON.split(' ')
console.log("Example input - Mississauga, Ontario: " + ON)
console.log("Output - " + snowRatio(ONsplit[0], ONsplit[1]) + ": 1")
console.log("")
